...
Bastions:
* Turn left, burn towards outgate (K1 & S1), start with Scorch/Null, bastion as soon as you reach top speed, you should be roughly 1/3 through your burn (see x), this lets you drift towards outgate while maintaing bastion. Make sure to use Conflag as Paladin's during bastion, Null for Kronos unless all three battleships are within Void range.
